...
//if you are in the air and were just tossed then do this:
     ...
     //Serial.println("Just tossed");
      ...
      t_tossed = t_now;
      t_in_air = 0;
//if you are in the air and were not just tossed then do this:
     if (!recently_in_hand){                          
     //Serial.println("Weeee");
      t_in_air = t_now - t_tossed;
      }

//Set the color of the ball according to how long it has been in the air
//between 0 and t_low
      pixels.setPixelColor(i, pixels.Color(100, 0, 0, 0));

//between t_low and t_mid
      if (t_in_air > t_Low){
        pixels.setPixelColor(i, pixels.Color(100, 100, 0, 0));
      }        
      }
...
//if you in the are and were just thrown then do this
    if (recently_in_hand) {
//      Serial.println("Just thrown");
      recently_in_hand = false;
      t_thrown = micros();
      t_last = t_thrown;
      for(int i=0; i<NUMPIXELS; i++) { 
