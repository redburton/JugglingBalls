# 1 "d:\\Git\\JugglingBalls\\Sosuke_01.ino\\Sosuke_01.ino.ino"
//************************************************************
//************************ Include ***************************
//************************************************************

# 6 "d:\\Git\\JugglingBalls\\Sosuke_01.ino\\Sosuke_01.ino.ino" 2
# 7 "d:\\Git\\JugglingBalls\\Sosuke_01.ino\\Sosuke_01.ino.ino" 2
# 8 "d:\\Git\\JugglingBalls\\Sosuke_01.ino\\Sosuke_01.ino.ino" 2
# 9 "d:\\Git\\JugglingBalls\\Sosuke_01.ino\\Sosuke_01.ino.ino" 2
...
//NeoPixel 7
  ...
  Adafruit_NeoPixel pixels(14, 1 /* (Arduino is 13, Teensy is 11, Teensy++ is 6)*/, ((3<<6) | (1<<4) | (0<<2) | (2)) /*|< Transmit as G,R,B,W*/ + 0x0000 /*|< 800 KHz data transmission*/);
...
void setup(void) {
  ...
  // configure LED for output
    pinMode(1 /* (Arduino is 13, Teensy is 11, Teensy++ is 6)*/, (0x1));
...
void loop() {
  ...
  vSumAcc =(sqrt(((a.acceleration.x)*(a.acceleration.x))+((a.acceleration.y)*(a.acceleration.y))+((a.acceleration.z)*(a.acceleration.z))));
